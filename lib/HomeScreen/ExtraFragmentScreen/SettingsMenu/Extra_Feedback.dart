...
class ExtraFeedback extends StatefulWidget {
  const ExtraFeedback({Key? key}) : super(key: key);

  @override
  State<ExtraFeedback> createState() => _ExtraFeedbackState();
}

class _ExtraFeedbackState extends State<ExtraFeedback> {
      ...
      child: WillPopScope(
        onWillPop: () async {
          Navigator.pushReplacement(
              context, MaterialPageRoute(builder: (context) => Extrareadmore()));
          return false;
        },
        child: Scaffold(
