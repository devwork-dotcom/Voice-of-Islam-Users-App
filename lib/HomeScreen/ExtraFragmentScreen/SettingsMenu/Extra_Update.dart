...
class ExtraUpdate extends StatefulWidget {
  const ExtraUpdate({super.key});

  @override
  State<ExtraUpdate> createState() => _ExtraUpdateState();
}

class _ExtraUpdateState extends State<ExtraUpdate> {
  ...
  Future<void> _saveProfileData() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ExtraProfile()), // Navigate to another screen
    );
  }
  @override
