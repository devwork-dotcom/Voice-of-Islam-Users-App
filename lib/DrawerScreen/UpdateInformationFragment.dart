...
class Updateinformationfragment extends StatefulWidget {
  const Updateinformationfragment({super.key});

  @override
  State<Updateinformationfragment> createState() => _UpdateinformationfragmentState();
}

class _UpdateinformationfragmentState extends State<Updateinformationfragment> {
  ...
  Future<void> _saveProfileData() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Profilefragment()), // Navigate to another screen
    );
  }
                    ...
                    Positioned(
                      left: 190.w,
                        ...
                        child: GestureDetector(
                          ...
                          child: CircleAvatar(
                            backgroundColor: MyColors.deep_blue,
                            radius: 20.r,
                      ...
                      Align(
                        ...
                        child: SizedBox(
                          ...
                          child: Text('Blood Type : ',style: TextStyle(
                            fontWeight: FontWeight.bold,fontSize: 20.sp,color: MyColors.deep_blue
                          ),),
                        ),
                      ),
                      ...
                      child: Center(
                        child: Row(
                          ...
                          children: [
                            ...
                            Icon(Icons.double_arrow_sharp,color: MyColors.white,size: 18.w,)
                          ],
                        ),
                      ),
                    ),
